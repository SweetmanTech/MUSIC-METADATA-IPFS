import { FileInput, Box, VisuallyHidden, BoxProps, Spinner, IconExclamation, IconUpload, Tag, IconClose, Button } from 'degen'
...
type Audio =
  ...
  | 'audio/mp3'
  | 'audio/wave'
  | 'audio/wav, audio/mp3, audio/wave, audio/mpeg'
export type Accept = Image | Audio | `${Image}, ${Audio}`
